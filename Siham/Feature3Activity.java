...
public class Feature3Activity extends AppCompatActivity {
    ...
    //Objects' declaration
    Button backBtn, getStartedBtn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.feature_page_3);

        //Object initialization
        backBtn = findViewById(R.id.btnBackToF2);
        ...
        getStartedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Intent f3Intent = new Intent(Feature3Activity.this, );
