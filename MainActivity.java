    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSaveMajor.setOnClickListener(v -> {
            ...
            if (!major.isEmpty()) {
                ...
                PreferencesManager.setUserMajor(MainActivity.this, major);
                // Notify the user that the major has been saved
                Toast.makeText(MainActivity.this, "Major saved successfully!", Toast.LENGTH_SHORT).show();
            } else {
                // Notify the user to enter a major if the EditText is empty
                Toast.makeText(MainActivity.this, "Please enter a major.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnToReceivedRequests.setOnClickListener(v -> navigateTo(ReceivedRequestsActivity.class));

        Button btnToSentRequests = findViewById(R.id.btn_to_sent_requests);
        btnToSentRequests.setOnClickListener(v -> navigateTo(SentRequestsActivity.class));

        Button btnToSearch = findViewById(R.id.btn_to_search);
        btnToSearch.setOnClickListener(v -> navigateTo(SearchActivity.class));
