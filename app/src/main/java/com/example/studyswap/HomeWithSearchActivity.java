...
public class HomeWithSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton sentRequestsButton = findViewById(R.id.sent_requests_button);
        ImageButton receivedRequestsButton = findViewById(R.id.received_requests_button);

        homeButton.setOnClickListener(v -> openActivity(HomeWithSearchActivity.class));
        profileButton.setOnClickListener(v -> openActivity(Profile.class));
        sentRequestsButton.setOnClickListener(v -> openActivity(SentRequests.class));
        receivedRequestsButton.setOnClickListener(v -> openActivity(ReceivedRequests.class));
